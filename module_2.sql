...
--
-- Name: gen_info; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.gen_info OWNER TO postgres;
...
COPY public.counter (name, count) FROM stdin;
animals	10
school	10
SF	10
human	10
...
--
-- Data for Name: gen_info; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.gen_info (gender_information) FROM stdin;
We have 3 boys!
We have 3 girls!
\.
