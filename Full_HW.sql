...
--
-- Name: tourist_vasited; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.tourist_vasited (
    tourist_id integer DEFAULT 0 NOT NULL,
    visited_id integer DEFAULT 0 NOT NULL
);


ALTER TABLE public.tourist_vasited OWNER TO postgres;
...
--
-- Data for Name: tourist_vasited; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.tourist_vasited (tourist_id, visited_id) FROM stdin;
1	4
2	1
3	3
4	5
